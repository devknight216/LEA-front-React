      ...
      <div className="max-w-4xl mx-auto rounded-md shadow-md p-3 sm:p-8 bg-white px-2">
          ...
          <div className="bg-white px-4 py-5 border-gray-200 sm:px-6 space-y-4">
            ...
            <div>
              ...
              <p className="italic font-medium text-gray-600 text-sm">
                If you selected to allow pets inside the property, you can also set a fee for each pet per night.
              </p>
              <div className="grid grid-cols-1 sm:grid-cols-2 sm:gap-4 items-center px-5 py-5">
                <div>
                  <InputBox
                    ...
                    disabled={!property.amenities.filter((item) => item === "Pets Allowed").length}
                  />
                </div>
                <div>
            ...
            <div>
              ...
              <p className="italic font-medium text-gray-600 text-sm">
                Legendary Estates Airbnb can manage your property and handle everything for you. If you agree to have your
                property managed by Legendary Estates Airbnb, 20% of platform sales will go to Legendary Estates Airbnb.
              </p>
              <div className="px-5 py-5">
                <Toggle
                  label={"Do you want Legendary Estates Airbnb to manage the property for you?"}
                  getToggleValue={getManageTypeToggle}
                  removeToggleValue={removeManageTypeToggle}
                />
              </div>
            </div>
            <div>
              ...
              <p className="italic font-medium text-gray-600 text-sm">
                Legendary Estates Airbnb also offers staging that will surely transform your space and get bookings in no time!
                Staging by Legendary Estates Airbnb starts at $80 per hour.
              </p>
        ...
        <footer>
          <div className="py-5 flex justify-between">
            <button className="bg-red-500 focus:bg-red-700 text-white px-10 py-2 rounded-md" onClick={previousStep}>
              Prev
            </button>
            <button className="bg-red-500 focus:bg-red-700 text-white px-10 py-2 rounded-md" onClick={createNewSpace}>
              Create
            </button>
          </div>
