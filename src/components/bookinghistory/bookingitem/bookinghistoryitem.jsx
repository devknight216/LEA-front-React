        ...
        <div className="w-full flex items-center justify-between px-6 py-3 space-x-6">
          <div className="flex-1 truncate">
            <div className="flex items-center space-x-3">
              <a
                href={`/details/${reservation?.property?._id}`}
                target="_blank"
                className="text-gray-900 text-sm font-medium truncate hover:text-indigo-500 cursor-pointer"
                rel="noreferrer"
              >
            ...
            <p className="mt-1 text-gray-500 text-sm truncate">
              {reservation?.from?.substr(0, 10)} to {reservation?.to?.substr(0, 10)}
            </p>
          </div>
