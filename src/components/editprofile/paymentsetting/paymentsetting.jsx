          ...
          <div>
            ...
            <div>
              <div className="p-3 rounded-md">
                ...
                <div className="px-5">
                  <button
                    className="flex items-center gap-4 bg-red-500 text-white px-5 py-2 rounded hover:bg-red-700"
                    onClick={addPayoutMethod}
                  >
                    Connect with Stripe
                    {payoutlodding && (
                      <SpinnerCircularFixed size={20} thickness={200} speed={100} color="#ff0000" secondaryColor="#D9D9D6" />
                    )}
                  </button>
        ...
        <div>
          ...
          <div>
            <div className="p-3 rounded-md">
              ...
              <p className="py-3 text-gray-500">
                If you are registered for VAT or your stay is for business, you may not be charged VAT on Airbnb service fees. To
                get started, enter your business’ VAT ID Number.
              </p>
              <div className="px-5">
