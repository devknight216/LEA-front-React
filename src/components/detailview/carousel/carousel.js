...
function DetailViewCarouselComponent({images}) {
  ...
  return (
    <div className="mx-auto container">
      {
        images && <div className="mt-6 max-w-7xl mx-auto cursor-pointer" onClick={()=>{setIsOpen(true)}}>
      ...
      {
        images && <ImageViewComponent isOpen={isOpen} closeViewer={()=>{setIsOpen(false)}} images={images}/>
      }
    </div>
  )
}
