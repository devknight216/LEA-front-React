                        ...
                        >
                          <Popover.Panel static className="hidden md:block absolute z-10 top-full inset-x-0 transform shadow-lg">
                            ...
                            <div className="relative max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2">
                              ...
                              <div className="bg-gray-50 px-4 py-8 sm:py-12 sm:px-6 lg:px-8 xl:pl-12"></div>
                            </div>
                          </Popover.Panel>
                        </Transition>
                      </>
              ...
              <div className="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 bg-white divide-y-2 divide-gray-50">
                <div className="pt-5 pb-6 px-5 sm:pb-8">
                  <div className="flex items-center justify-between">
                    <div>
                      <img className="h-16 w-auto" src={BrandIcon} alt="Workflow" />
                    </div>
                    <div className="-mr-2">
                      <Popover.Button className="bg-white rounded-md p-2 inline-flex items-center justify-center text-gray-400 hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-500">
                  ...
                  <div className="mt-6 sm:mt-8">
                    <nav>
                      <div className="grid gap-7 sm:grid-cols-2 sm:gap-y-8 sm:gap-x-4">{/* place mobile search here */}</div>
                ...
                <div className="py-6 px-5">
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    {authUser?.role == "admin" && (
                      <Link to="/admin" className="rounded-md text-base font-medium text-gray-900 hover:text-gray-700">
                        Admin
                      </Link>
                    )}
                  </div>
