      ...
      <div className="relative bg-white">
        <div className="lg:absolute lg:inset-0">
          <div className="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
            <img className="h-56 w-full object-cover lg:absolute lg:h-full" src={HomeImage} alt="" />
          </div>
        </div>
          ...
          <div className="lg:pr-8">
            <div className="max-w-md mx-auto sm:max-w-lg lg:mx-0">
              ...
              <p className="mt-4 text-lg text-gray-500 sm:mt-3">
                Legendary Estates Airbnb also offers Staging services to help you spruce up your property and get it rented
                faster! Learn more about our staging services and schedule an appointment with our Qualified Staging Consultants
                to know what can we do to improve your space.
              </p>
              <div className="mt-8">
