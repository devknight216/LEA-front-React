      ...
      <div className="relative max-w-7xl mx-auto pt-20 pb-12 px-4 sm:px-6 lg:px-8 lg:py-20">
        ...
        <div className="relative lg:flex lg:items-center">
          <div className="hidden lg:block lg:flex-shrink-0">
            <img className="h-64 w-64 rounded-full xl:h-80 xl:w-80" src={WomenAvatar1} alt="" />
          </div>
          ...
          <div className="relative lg:ml-10">
            ...
            <blockquote className="relative">
              <div className="text-2xl leading-9 font-medium text-gray-900">
                <p>
                  The best Airbnb I’ve been to in Houston. The building is nice and very clean. They also have huge TVs and plenty
                  of restaurants around within walking distance. I would stay here again without question.
                </p>
              </div>
              <footer className="mt-8">
                <div className="flex">
                  <div className="flex-shrink-0 lg:hidden">
                    <img className="h-12 w-12 rounded-full" src={WomenAvatar1} alt="" />
                  </div>
