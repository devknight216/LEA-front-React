            ...
            <blockquote className="mt-6 md:flex-grow md:flex md:flex-col">
              <div className="relative text-lg font-medium text-gray-600 md:flex-grow">
                ...
                <p className="relative">
                    Host was very understanding and accommodating. More specifically because of the pandemic that we’re facing. I really appreciated the quick tips and fast response. 
                    I’d love to stay there again and experience the sky deck and pool at the top. Awesome space!
                </p>
              </div>
            ...
            <blockquote className="mt-6 md:flex-grow md:flex md:flex-col">
              <div className="relative text-lg font-medium text-gray-600 md:flex-grow">
                ...
                <p className="relative">
                    ...
                    The building is secure, clean, and quiet. It is right on the Metrorail line for access to NRG Park or going North to MinuteMaid Park.
                </p>
              </div>
              <footer className="mt-8">
                <div className="flex items-start">
