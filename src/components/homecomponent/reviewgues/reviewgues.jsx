          ...
          <blockquote className="mt-6 md:flex-grow md:flex md:flex-col">
            <div className="relative text-lg font-medium text-gray-600 md:flex-grow">
              ...
              <p className="relative">
                The host was very understanding and accommodating. Specially during this time of a pandemic that we’re facing. I
                really appreciate the quick tips and fast response. I’d love to stay there again and experience the sky deck and
                pool at the top. Awesome space!
              </p>
            </div>
            <footer className="mt-8">
              <div className="flex items-start">
                <div className="flex-shrink-0 inline-flex rounded-full border-2 border-yellow-600">
                  <img className="h-12 w-12 rounded-full" src={WomenAvatar2} alt="" />
                </div>
                <div className="ml-4">
        ...
        <div className="py-12 px-4 border-t-2 border-yellow-500 sm:px-6 md:py-16 md:pr-0 md:pl-10 md:border-t-0 md:border-l lg:pl-16">
          <blockquote className="mt-6 md:flex-grow md:flex md:flex-col">
            <div className="relative text-lg font-medium text-gray-600 md:flex-grow">
              ...
              <p className="relative">
                If you are looking for an upscale spot to blend in with the local Houstonians, you have found the place! The
                building is secure, clean, and quiet. It is right on the Metrorail line for access to NRG Park or going North to
                Minute Maid Park.
              </p>
            </div>
            <footer className="mt-8">
              <div className="flex items-start mt-10">
                <div className="flex-shrink-0 inline-flex rounded-full border-2 border-yellow-600">
                  <img className="h-12 w-12 rounded-full" src={MenAvatar} alt="" />
                </div>
                <div className="ml-4">
