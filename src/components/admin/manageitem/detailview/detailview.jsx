      ...
      <div className="space-y-4">
        ...
        <div className="space-y-2 px-3">
          <div className="leading-6 space-y-1 text-sm">
            <p>
              Nightly Rate: <span className="text-indigo-600 font-medium text-lg">${selected?.nightlyRate}</span>
            </p>
            <p>Property Name:</p>
        ...
        <div className="flex justify-center flex-wrap">
          <div
            className="px-10 py-2 w-max mx-auto bg-yellow-500 text-white text-center hover:bg-yellow-700 rounded-md cursor-pointer"
            onClick={gotoDetailPropertyPage}
          >
            Detail View
          </div>
          <div
            className="px-10 py-2 w-max mx-auto bg-green-500 text-white text-center hover:bg-green-700 rounded-md cursor-pointer"
            onClick={gotoEditPropertyPage}
          >
            Edit Fields
          </div>
        </div>
