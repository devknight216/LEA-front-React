export const typeArray = ['','Apartment', 'House', 'Condo / Townhome', 'Secondary Unit', 'Unique Space', 'Bed and Breakfast', 'Boutique Hotel', 'Duplex', 'RV / Camper', 'Tiny House']
export const spaceArray =['', 'An entire place', 'A private room', 'A shared room'];
