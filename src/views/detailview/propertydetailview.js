                    ...
                    <div className="text-center w-full">
                      ...
                      <div className="flow-root mt-6">
                        <ul className="-my-5">
                          ...
                          <li className="border-0 py-2 text-sm text-gray-500">Hosted By <span className="font-bold text-lg text-gray-700">{ property?.hostInfo?.name }</span></li>
                          <li className="border-0 py-2 text-gray-500">{ property?.propertyType }, { property?.propertySpaceFeature }</li>
                        </ul>
                      </div>
