            ...
            <div className="grid grid-cols-1 gap-4 items-start lg:grid-cols-3 lg:gap-8">
              ...
              <div className="grid grid-cols-1 gap-4 lg:col-span-2">
                      ...
                      <div className="sm:flex sm:items-center sm:justify-between">
                        <div className="sm:flex sm:space-x-5">
                          <div className="mt-4 text-center sm:mt-0 sm:pt-1 sm:text-left">
                            ...
                            <p className="text-xl font-bold text-gray-900 sm:text-2xl">Spacious Midtown/ Downtown mid rise</p>
                            <p className="text-sm font-medium text-gray-600">Legendary Real Estate</p>
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="rounded-lg bg-gray-200 overflow-hidden shadow divide-y divide-gray-200 sm:divide-y-0 sm:gap-px">
                    <div className="px-4 py-8 w-100">
                      ...
                      <span className="text-gray-600">
                        Cum qui rem deleniti. Suscipit in dolor veritatis sequi aut. Vero ut earum quis deleniti. Ut a sunt eum cum ut repudiandae possimus. 
                ...
                <section aria-labelledby="quick-links-title">
                  <div className="rounded-lg bg-gray-200 overflow-hidden shadow divide-y divide-gray-200 sm:divide-y-0 sm:gap-px">
                    <div className="px-4 py-8 w-100">
                      <p className="text-gray-600 text-lg font-bold">What this place offers</p>   
                      <span className="text-gray-600">
                        Cum qui rem deleniti. Suscipit in dolor veritatis sequi aut. Vero ut earum quis deleniti. Ut a sunt eum cum ut repudiandae possimus. 
                        Nihil ex tempora neque cum consectetur dolores.
                      </span>               
                ...
                <section>
                <p className="text-gray-600 text-lg font-bold">Select check-in date</p>  
                  <DateRangerComponent/>
                </section>
              </div>
                      ...
                      <div className="flow-root mt-6">
                        <ul className="-my-5 py-5">
                          ...
                          <div className='py-5 px-10'>
                            <p className='text-gray-800'><span className='text-lg font-bold'>2300USD</span>/Night</p>
                          ...
                          {recentHires.map((person) => (
                            <li key={person.handle} className="py-4">
                              <div className="flex items-center space-x-4">
                                ...
                                <div>
                                  <ReactStars size={15} value={5} edit={false}/>
                                </div>
                                <div>
                                  <a
                                    href={person.href}
