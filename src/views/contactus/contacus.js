...
import RecaptureComponent from 'components/recapture'
...
export default function ContactUsPage() {
  ...
  //Recapture
  const [recaptureCallback, setrecaptureCallback] = useState(null);
  const [isShowRecapture, setIsShowRecapture] = useState(true);
      ...
      <div className="max-w-7xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:px-8">
        <div className="relative bg-white shadow-xl">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3">
            {/* Contact information */}
            <div className="relative overflow-hidden py-10 px-6 bg-yellow-300 sm:px-10 xl:p-12">
              ...
              <p className="mt-6 text-base text-gray-600 max-w-3xl">
                We are ready to answer your queries and questions. Fill out the contact form and one of our property consultants will reach out to you. 
              </p>
              <dl className="mt-8 space-y-6">
                ...
                <dd className="flex text-base text-gray-600">
                  ...
                  <span className="ml-3">(225)614-3878</span>
                </dd>
                <dt>
              ...
              <ul className="mt-8 flex space-x-12" role="list">
                ...
                <li>
                  <a className="text-white hover:text-indigo-100" href="https://www.instagram.com/legendaryestatesairbnb/">
