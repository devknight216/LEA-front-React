    ...
    return (
        <div>
           <div className="max-w-5xl mx-auto py-16 px-5">
                ...
                <div className="py-2">
                    <span className="text-gray-600">You can start learning the proven methods we have used for the past 2 years to earn over $10,000 a month, that's over $100,000 a year. The infamous 6 figures everyone chases!</span>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-16 py-10 text-gray-600">
                    <div>
                        <img src={Bg1} className="w-full h-auto object-cover"/>
                        <div className="p-5">
                            <span>This business requires very little time which gives you something more precious than money…TIME FREEDOM! Think about what you could do if you had that? You could spend more time with your family, travel, or finally pursue that passion you have always wanted to.</span>
                        </div>
                        <img src={Bg2} className="w-full h-auto object-cover"/>
                    </div>
                    <div>
                        <div className="p-5" className="w-full h-auto">
                            <span>We are creating a real community of online entrepreneurs. With Airbnb becoming a first choice over Hotel stays, it gives you an opportunity to make profit for your Vacation Property! This course will show you how to make money from other people's properties without the risk of having to pay a closing cost for owning.</span>
                        </div>
                        <img src={Bg3} className="w-full h-auto object-cover my-5 md:my-10"/>
                        <div className="p-5" className="w-full h-auto">
                            <span>Be one of the students to enroll and learn all of my closely guarded secrets! Am I going to guarantee you overnight success? Absolutely not, that would be unrealistic, we're all mature enough to know that there are no guarantees in life. Anyone promising that is lying. This is a real business that requires real work that can take months to even a year to produce the income you're looking for. Here is what I can promise you…</span>
                        </div>
                    </div>
                </div>
                <div>
